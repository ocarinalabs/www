        ...
        <div className="flex flex-col items-center space-y-8">
          <header className="flex flex-col items-center space-y-4">
            <div className="flex items-center">
              ...
              <h1 className="ml-3 text-5xl font-heming font-light">
                sidekick
              </h1>
            </div>
          ...
          <nav className="flex space-x-6 text-lg font-light text-gray-400">
            <Link href="/robin" className="font-heming hover:text-white text-zinc-500 transition-colors underline">
              robin
            </Link>
            <Link href="/labs" className="font-heming hover:text-white text-orange-500 transition-colors underline">
              labs
            </Link>
            <Link href="/founders" className="font-heming hover:text-white text-green-500 transition-colors underline">
              founders
            </Link>
          </nav>
        </div>
