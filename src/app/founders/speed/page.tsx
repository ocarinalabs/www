        ...
        <div className="container mx-auto px-6 pb-10 max-w-3xl">
          ...
          <section className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-300 font-sans">
                Startups are truthfully a numbers game. Even the best founders
                have hit rates under 10%. Just look at founders like Pieter
                Levels.
              </p>
            ...
            <div className="flex flex-col items-center my-8">
              ...
              <p className="text-xs text-gray-500 text-center mt-4">
                Time waits for no one. Every second you hesitate, someone else
                is shipping.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-300 font-sans">
                In Malaysia, we&apos;re taught to plan extensively. To get
                buy-in from everyone. To make sure everything is perfect before
                launch. To not &quot;malu&quot; ourselves with something
                half-baked.
              </p>
              <p className="text-sm text-gray-300 font-sans">
                Meanwhile, a kid in San Francisco launched three products while
                you were still designing your logo.
              </p>
              <p className="text-sm text-gray-300 font-sans">
                Here&apos;s the truth: Your first version will suck anyway. The
                difference is whether it sucks after 6 months of building or 6
                days.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-300 font-sans">
                Speed isn&apos;t about being sloppy. It&apos;s about being smart
                about what matters.
              </p>
              ...
              <p className="text-sm text-gray-300 font-sans">
                If you can&apos;t explain your idea in one page, it&apos;s too
                complex. If you can&apos;t build a landing page in one day,
                you&apos;re overthinking. If you can&apos;t get users in one
                week, there&apos;s no demand.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-gray-300 font-sans">
                ...
                <li>
                  • Speed beats fear (no time to be scared when you&apos;re
                  moving)
                </li>
                <li>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-300 font-sans">
                Moving fast doesn&apos;t mean being reckless. It means being
                ruthless about what doesn&apos;t matter.
              </p>
              <p className="text-sm text-gray-300 font-sans">
                Your code doesn&apos;t need to be perfect. Your design
                doesn&apos;t need to win awards. Your infrastructure
                doesn&apos;t need to scale to a million users.
              </p>
              <p className="text-sm text-gray-300 font-sans">
                You know what needs to be perfect? Finding out if anyone gives a
                shit.
              </p>
              <p className="text-sm text-gray-300 font-sans font-semibold">
