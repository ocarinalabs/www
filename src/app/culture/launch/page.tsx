          ...
          <section className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-300 font-sans">
                You should NOT spend hundreds of hours building a product... until
                you know for certain that there is demand.
              </p>
              <p className="text-sm text-gray-300 font-sans">
              ...
              <p className="text-sm text-gray-300 font-sans">
                Add a stripe checkout button. Launch everywhere. Market for 1 week
                straight.
              </p>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-300 font-sans">
                Most &quot;startups&quot; are not winners. And there are only THREE 
                reasons why someone will not pay you:
              </p>
              <ol className="space-y-2 text-sm text-gray-300 font-sans list-decimal list-inside">
                ...
                <li>They don&apos;t think your product is good enough to try and pay for.</li>
              </ol>
              <p className="text-sm text-gray-300 font-sans">
                A landing page with a checkout button tells you which one in 7 days. 
                Building for 6 months tells you nothing.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-gray-300 font-sans">
                <li>• It is not unethical to advertise a product you have not finished building.</li>
                <li>• It is not unethical to put a checkout link and collect payments for an unfinished product to test demand… as long as you simply refund &quot;customers&quot;.</li>
              </ul>
              <p className="text-sm text-gray-300 font-sans">
              ...
              <p className="text-sm text-gray-300 font-sans italic border-l-2 border-gray-600 pl-4">
                &quot;I actually haven&apos;t finished the product yet, but I&apos;d
                love to talk to you about the problem you&apos;re facing. I put a
                sign up link on the website to see if anyone would actually care
                about my product enough to pay for it&quot;
              </p>
              <p className="text-sm text-gray-300 font-sans">
                Then you refund the customer. And now you have a validated idea AND 
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4 text-sm text-gray-300 font-sans">
                <div className="bg-gray-900/50 p-4 rounded-lg">
                  <p className="font-semibold mb-2">Day 1: Build Landing Page</p>
                ...
                <div className="bg-gray-900/50 p-4 rounded-lg">
                  <p className="font-semibold mb-2">Day 2-7: Launch Everywhere</p>
                  <ul className="space-y-1 text-xs">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-300 font-sans">
                This is personally how I tested 39 different startups… and killed 
                37 of them with little to no revenue to show for it.
              </p>
              <p className="text-sm text-gray-300 font-sans">
              ...
              <ul className="space-y-2 text-sm text-gray-300 font-sans">
                ...
                <li>• Rivin.ai went on to raise an investment from Jason Calacanis and works with multi-billion dollar e-commerce brands</li>
              </ul>
              <p className="text-sm text-gray-300 font-sans">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-300 font-sans">
                Do not waste hundreds of hours of your valuable time building products 
                no one cares about.
              </p>
              <p className="text-sm text-gray-300 font-sans">
