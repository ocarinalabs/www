...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    short_name: 'Korrect',
    description: 'Korrect builds aligned AI systems that remain safe as they grow powerful. We prioritize alignment over capability, transparency over efficiency, and humanity\'s future over the AI race.',
    start_url: '/',
    display: 'standalone',
